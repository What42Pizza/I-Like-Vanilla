...
#define BLOCK_COLOR_DARK vec3(BLOCK_RED_DARK, BLOCK_GREEN_DARK, BLOCK_BLUE_DARK) * BLOCK_BRIGHTNESS_DARK
#define BLOCK_COLOR_BRIGHT vec3(BLOCK_RED_BRIGHT, BLOCK_GREEN_BRIGHT, BLOCK_BLUE_BRIGHT) * BLOCK_BRIGHTNESS_BRIGHT
