...
#define END_SKY_COLOR vec3(END_SKY_RED, END_SKY_GREEN, END_SKY_BLUE) * END_SKY_BRIGHTNESS
#define END_STATIC_COLOR vec3(END_STATIC_RED, END_STATIC_GREEN, END_STATIC_BLUE) * END_STATIC_BRIGHTNESS
