						...
						if (materialId < 1704u) { // 1700..1704
							...
							if (materialId < 1707u) { // 1704..1707
								if (materialId == 1704u) {
									...
									// emerald ore
									SET_GLOWING_COLOR(
										vec3(126.0,  14.9,  48.2),
										vec3(162.0, 100.0, 100.0),
										GLOWING_ORES_STRENGTH
									);
								} else {
									// lapis ore
									SET_GLOWING_COLOR(
										vec3(198.0, 57.0, 54.5),
										vec3(234.0, 91.5, 95.7),
										GLOWING_ORES_STRENGTH
									);
								}
							} else { // 1707..1900
								if (materialId == 1707u) {
									// diamond ore
									SET_GLOWING_COLOR(
										vec3(162.0, 16.5,  57.3),
										vec3(184.0, 86.3, 100.0),
										GLOWING_ORES_STRENGTH
									);
