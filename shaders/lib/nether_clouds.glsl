...
float sampleNetherCloud(vec3 pos) {
	...
	cloudSample += valueNoise((pos + frameTimeCounter * 0.125  ) * 1.0 ) * 1.0 ;
	cloudSample += valueNoise((pos + frameTimeCounter * 0.0625 ) * 0.5 ) * 0.75;
	cloudSample += valueNoise((pos + frameTimeCounter * 0.03125) * 0.25) * 0.5 ;
