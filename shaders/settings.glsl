...
#define SKY_FOG_DAY_COLOR vec3(SKY_FOG_DAY_RED, SKY_FOG_DAY_GREEN, SKY_FOG_DAY_BLUE)
#define SKY_FOG_NIGHT_COLOR vec3(SKY_FOG_NIGHT_RED, SKY_FOG_NIGHT_GREEN, SKY_FOG_NIGHT_BLUE)
#define SKY_FOG_SUNRISE_COLOR vec3(SKY_FOG_SUNRISE_RED, SKY_FOG_SUNRISE_GREEN, SKY_FOG_SUNRISE_BLUE)
#define SKY_FOG_SUNSET_COLOR vec3(SKY_FOG_SUNSET_RED, SKY_FOG_SUNSET_GREEN, SKY_FOG_SUNSET_BLUE)
